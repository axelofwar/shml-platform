---
description: "Use when writing code that handles credentials, secrets, environment variables, authentication, or external inputs. Covers OWASP Top 10, ggshield pre-commit hooks, and Docker secrets patterns."
applyTo: "**/*.py,**/*.sh,**/*.yml,**/*.env*"
---
