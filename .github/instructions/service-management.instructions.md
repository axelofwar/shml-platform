---
description: "Use when restarting, starting, or stopping services; writing docker-compose files; modifying Taskfile.yml; managing the platform lifecycle. Covers mandatory start_all_safe.sh usage, task runner commands, and deploy library patterns."
applyTo: "**/*.yml,**/*.sh,**/docker-compose*,Taskfile.yml"
---
