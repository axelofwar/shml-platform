...
model_path = helper.load_model_from_registry("face-detection-yolov8l-p2", stage="Production")

# Promote model
helper.promote_model_to_production("face-detection-yolov8l-p2", version=3)

# Compare models
helper.compare_models("face-detection-yolov8l-p2", versions=[1, 2, 3], metric="recall")
```
