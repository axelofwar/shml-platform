...
class TestGatewayQueueAPI:
    ...
    def test_queue_status(self):
        ...
        try:
            response = requests.get(
                get_inference_url("/inference/queue/status"),
                timeout=5
            )
    ...
    def test_rate_limit_headers(self):
        ...
        try:
            response = requests.get(
                get_inference_url("/inference/health"),
                timeout=5
            )
...
class TestGPUYieldAPI:
    ...
    def test_yield_endpoint_exists(self):
        ...
        try:
            response = requests.post(
                get_inference_url("/api/image/yield-to-training"),
                timeout=5
            )
    ...
    def test_model_status_endpoint(self):
        ...
        try:
            response = requests.get(
                get_inference_url("/api/image/model/status"),
                timeout=5
            )
...
class TestDockerComposeValidation:
    ...
    def test_docker_compose_file_exists(self):
        ...
        compose_path = Path(__file__).parent.parent.parent / "inference" / "docker-compose.inference.yml"
        
        # Try relative paths
        possible_paths = [
            compose_path,
            Path("/home/axelofwar/Desktop/Projects/ml-platform/inference/docker-compose.inference.yml"),
