...
from shml.admin.http import HTTPClient
from shml.admin.permissions import PermissionContext
...
def developer_context():
    ...
    from shml.admin.models import ROLE_PERMISSIONS
...
def users_service(mock_http_client, admin_context):
    ...
    from shml.admin.services import UsersService
...
def groups_service(mock_http_client, admin_context):
    ...
    from shml.admin.services import GroupsService
...
def applications_service(mock_http_client, admin_context):
    ...
    from shml.admin.services import ApplicationsService
...
def registrations_service(mock_http_client, admin_context):
    ...
    from shml.admin.services import RegistrationsService
...
def api_keys_service(mock_http_client, admin_context):
    ...
    from shml.admin.services import APIKeysService
