...
class TestChatMessageSchema:
    ...
    def test_invalid_role_rejected(self):
        ...
        message = {"role": "invalid_role", "content": "Some content"}
...
class TestImageGenerationResponse:
    ...
    def test_valid_response_structure(self):
        ...
        assert (
            image_data.get("url") is not None or image_data.get("b64_json") is not None
        )
...
class TestRateLimitConfig:
    ...
    def test_default_rate_limit(self):
        ...
        config = {"requests_per_minute": 60, "burst_limit": 10, "window_seconds": 60}
    ...
    def test_user_rate_limit_tiers(self):
        ...
        assert (
            tiers["premium"]["requests_per_minute"]
            > tiers["basic"]["requests_per_minute"]
        )
        assert (
            tiers["basic"]["requests_per_minute"] > tiers["free"]["requests_per_minute"]
        )
