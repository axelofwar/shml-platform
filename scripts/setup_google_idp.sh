...
#    https://sfml-platform.tail38b60a.ts.net/oauth2/callback
...
if [[ -z "$GOOGLE_CLIENT_ID" ]]; then
    ...
    echo "   - https://sfml-platform.tail38b60a.ts.net/oauth2/callback"
...
if [[ $? -eq 0 ]]; then
    ...
    echo ""
    echo "2. Test by visiting: https://sfml-platform.tail38b60a.ts.net/"
