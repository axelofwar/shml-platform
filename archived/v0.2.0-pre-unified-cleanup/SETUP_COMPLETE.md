...
14. **Authentik Server** - OAuth provider
15. **Authentik Worker** - Background tasks
16. **Authentik PostgreSQL** - Auth database
17. **Authentik Redis** - Auth cache
...
2. **Configure OAuth (optional):**
   - Authentik is running and ready
   - See `configure_oauth.sh` to enable
