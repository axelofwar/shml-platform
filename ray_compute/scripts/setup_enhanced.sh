...
echo "1. Open http://100.69.227.36:9000 (or http://localhost:9000)"
...
echo "   - Redirect URIs: http://100.69.227.36:8266/auth/callback"
...
echo "  - Grafana: http://100.69.227.36:3000"
echo "    User: $GRAFANA_ADMIN_USER"
echo "    Pass: $GRAFANA_ADMIN_PASSWORD"
echo "  - Prometheus: http://100.69.227.36:9090"
echo "  - Loki: http://100.69.227.36:3100"
echo ""
