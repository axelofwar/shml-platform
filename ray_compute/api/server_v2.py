...
class JobSubmitRequest(BaseModel):
    ...
    artifact_retention_days: int = Field(90, ge=1, le=365, description="Artifact retention")
...
async def get_user_quota(
    ...
    quota = db.query(UserQuota).filter(UserQuota.user_id == current_user.user_id).first()
