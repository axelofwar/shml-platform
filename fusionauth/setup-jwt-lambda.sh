...
echo "   URL: https://shml-platform.tail38b60a.ts.net/admin"
echo ""
...
echo "   Option A: Users clear cookies for shml-platform.tail38b60a.ts.net"
...
echo "   - Homer Dashboard (https://shml-platform.tail38b60a.ts.net/)"
echo "   - Grafana (https://shml-platform.tail38b60a.ts.net/grafana)"
echo ""
...
echo "   OAuth2-Proxy Config:   docker-compose.infra.yml (lines 260-400)"
